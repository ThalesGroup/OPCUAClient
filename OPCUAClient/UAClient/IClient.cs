...
namespace Thales.OPCUAClient.UAClient
{
    ...
    {
        /// <summary>
        /// Add value to the queue for sending to OPC UA server
        /// </summary>
        /// <param name="val"></param>
        void AddValue(SendValue val);

        /// <summary>
        /// Start OPC UA Client (connect to server, establish session, ready to write data to server)
        /// </summary>
        /// <returns></returns>
        Task StartAsync();

        /// <summary>
        /// Indicate OPC UA Client running and connected to OPC UA server
        /// </summary>
        bool IsRunning { get; }
    }
}

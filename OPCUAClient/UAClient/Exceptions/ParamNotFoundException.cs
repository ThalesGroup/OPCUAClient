...
namespace Thales.OPCUAClient.UAClient.Exceptions
{
    [Serializable]
    public class ParamNotFoundException : Exception
    {
        ...
        public ParamNotFoundException(string message, Exception innerException) : base(message, innerException)
        {
        }

        protected ParamNotFoundException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
